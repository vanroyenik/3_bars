...
if __name__=='__main__':
    ...
    data=load_json(adress)
    print ("\n")
    print ("The largest bas is: %s" % return_largest(data))
    print ("The smallest bar is: %s" % return_smallest(data))
    print ("\n")
    my_longitude=input("Give me your Longitude: ")
    my_latitude=input("Give me your Latitude: ")
    print ("\n")
    print("The nearest bar to you is: %s" % return_closest(data))
